export default function (data, css) {
  const duration = data.duration || 37.080;
...
`;
  ...
  let iframeTagsHtml = "";
  scenes.forEach((scene) => {
    iframeTagsHtml += `    <iframe id="iframe-scene\${scene.stt}" src="./templates/https-github-com-rany2-edge-tt/mpgpxxuj/compositions/scene_\${scene.stt}.html"></iframe>\n`;
  });
